...
// Empêche un clic sur un bouton (puce de suggestion, "+ Ajouter", "✕") de
// faire perdre le focus au champ Prénom/Nom avant que le clic ne soit pris
// en compte — sinon la recherche de foyer se relance en plein milieu du
// clic et fait "sauter" l'interface.
...
function maybeLookupHousehold() {
  ...
  // Le nom a changé : on repart de zéro pour éviter de mélanger des
  // convives issus de deux foyers différents.
